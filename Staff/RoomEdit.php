    ...
    <div class="contentBox">
        ...
        <div class="container">
            <fieldset>
                ...
                <form action="RoomEditProcess.php" method="POST">
                    ...
                    <div class="room-details">
                        <input type="radio" name="room" id="dot-1" value="2" <?php if ($data['roomType'] == '2') { echo 'checked'; } ?>>
                        <input type="radio" name="room" id="dot-2" value="4" <?php if ($data['roomType'] == '4') { echo 'checked'; } ?>>
                        <input type="radio" name="room" id="dot-3" value="8" <?php if ($data['roomType'] == '8') { echo 'checked'; } ?>>
                        <i class="fa fa-bed"></i>
                    ...
                    <div class="button">
                        <input type="submit" value="Update" name="editRoom" id="editRoom">
                    </div>
                </form>
            </fieldset>
        </div>
